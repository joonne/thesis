...
Mieltymykset voivat olla suoraan käyttäjältä kysyttyjä tai käyttäjän antamia tuotearvioita tai ne voidaan tulkita käyttäjän toiminnasta kuten klikkauksista tai sivun katselukerroista.
...
Tämä lähestymistapa on tyypiltään yhteistyösuodattamista ja idea sen takana on että jos käyttäjät pitivät samankaltaisista tuotteista aikaisemmin, he luultavasti pitävät samoja tuotteita ostaneiden henkilöiden suosituksia merkityksellisinä. \cite{ricci11}
...
Käyttäjillä puolestaan saattaa olla seuraavanlaisia odotuksia suosittelujärjestelmältä.
...
Amerikan suurimman verkkokaupan, Amazon.com:in, on aiemmin tiedetty käyttävät tuote-tuotteeseen yhteisösuodatusta.
