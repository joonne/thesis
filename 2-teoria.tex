...
Ihmisen terveys on esimerkki latentista tekjiästä, sillä
...
Tämä lähestymistapa on hyödyllinen, koska se muuttaa aiemman, ei-konveksin, ongelman neliömäiseksi, jolloin se voidaan ratkaista optimaalisesti. \cite{aberger14} Ei-konveksilla tarkoitetaan sellaista ongelmaa, jolla saattaa olla olemassa useita lokaaleja minimejä ja/tai maksimeita ja saattaa kestää kauan tunnistaa onko ongelmalla ratkaisua lainkaan tai että löydetty ratkaisu on myös globaali ratkaisu. \cite
