...
Hajotelma (factorization) on ainoastaan arvio, sillä $k$ on pieni. \cite{ryza15} \ref{matrix-factorization}

\begin{figure}[h]
	\caption{Matrisin tekijöihinjako (muokattu lähteestä \cite{ryza15})}
...
\begin{figure}[h]
	...
	\centering
	\includegraphics[scale=0.20]{emr2}
\end{figure}

Yllä oleva kuva esittää EMR-klusterin, jossa on master-solmu sekä neljä slave-solmua.
...
\begin{lstlisting}[caption=add-Funktio]
