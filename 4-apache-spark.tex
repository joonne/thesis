...
Olion kloonaamiseksi k‰ytet‰‰n case-luokan $copy$ metodia, koska $people$-Dataset oli m‰‰ritelty vakioksi.
...
Yll‰ olevassa ohjelmassa luodaan uusi DataFrame tietorakenne k‰ytt‰en \textit{spark.read} -funktiota.
...
\begin{itemize}
	\item \textbf{Koneoppimisalgoritmit} oppimisalgoritmeja kuten luokittelua, regressiota, klusterointia ja yhteisˆllist‰ suodatusta
...
T‰ss‰ tyˆss‰ tutustutaan MLlib-kirjaston tarjoamaan ALS-kirjastoon, jolla malli opetetaan.	
