...
T‰m‰ aineisto valittiin, jotta voitaisiin antaa arvioita elokuville, jotka on oikeasti n‰hty ja myˆs laitteiston vuoksi.
...
Sovelluksia voidaan ottaa k‰yttˆˆn klusterissa spark-submit tyˆkalun avulla, joka mahdollistaa Sparkin kaikkien tuettujen klusterinhoitajien k‰ytt‰misen yhtein‰isen k‰yttˆliittym‰n kautta.
T‰llˆin k‰ytt‰j‰n ei tarvitse m‰‰ritt‰‰ sovellusta toimimaan erikseen kaikkien kanssa.
...
Koska valmiita personoituja suositteluj‰rjestelmi‰ ei lˆydetty valmiina, tuloksia vertaillaan ei-personoituihin, Apache Pig j‰rjestelm‰ll‰ saatuihin tuloksiin.
Toteutus on muunnettu uudemmalle MovieLens ml-latest-small datasetin versiolle, mutta muutoin koodi on uudelleenk‰ytetty alkuper‰isess‰ muodossaan. \cite{pig_original_code} \cite{pig_own_code}
...
Pig:n infrastruktuurikerros koostuu k‰‰nt‰j‰st‰, joka tuottaa Map-Reduce ohjelmien p‰tki‰, joille suurimittaiset rinnakkaiset toteutukset lˆytyv‰t valmiina.
Pig:n kielikerros koostuu kielest‰ nimelt‰ Pig Latin, jolla on seuraavat ominaisuudet:

\begin{itemize}
	\item Ohjelmoinnin helppous.
	\item Rinnakkaisesti suoritettavien data-analyysi ohjelmien kirjoittaminen on helppoa.
	\item Monimutkaiset, useista toisistaan riippuvista datamuunnokset enkoodataan eksplisiittisesti data virtaus (flow) sekvenssein‰, jolloin niiden kirjoittaminen, ymm‰rt‰minen ja hallinta helpottuu.
	\item Optimointimahdollisuudet.
	\item Suorituksen automaattinen optimointi, joka antaa k‰ytt‰j‰n keskitty‰ semantiikkaan tehokkuuden sijaan.
	\item Laajennettavuus.
	\item K‰ytt‰j‰t voivat luoda omia funktioitaan erikoisk‰yttˆiseen prosessointiin.
\end{itemize}
