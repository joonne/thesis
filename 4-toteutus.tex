...
Itsenäinen spark sovellus tarkoittaa käyttövalmista $jar$ tiedostoa (Java ARchive) joka voidaan jakaa spark klusterille ja se sisältää koodin ja kaikki riippuvuudet.
...
Riveillä 89-102 haetaan henkilökohtaiset suositukset käyttämällä mallin $predict$ metodia, joka ottaa parametrinaan mahdollisien elokuvien joukon.
