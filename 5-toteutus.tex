...
Voidaan pystytt‰‰ esimerkiksi myˆs suoraan Spark-sovelluksesta.

MITEN ITSE TEIN? MISSƒ SE PIRUN LINKKI ON
...
Seuraavaksi $jar$-tiedosto l‰hete‰‰n S3-palveluun, jossa sijaitsee \textit{movielens} niminen bucket.
