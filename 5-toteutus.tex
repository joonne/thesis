...
GroupLens Research on kerännyt ja laittanut saataville vertailuaineistoja MovieLens -sivustolta.
...
Tämä ominaisuus osoittautui erittäin hyödylliseksi kun sovellusta ajettiin EMR-klusterissa, sillä spark-submit työkalu otti parametrinaan vain käännetyn JAR:in ja alkoi tekemään laskentaa.
...
- opetus
	- parametrien arvoille selitys ja että paperin mukaan
- ennustaminen
...
Eräässä tutkimuksessa \cite{miryala17} tutkittiin parhaita parametreja ALS-algoritmille ja päädytty lambda-arvoon 0.1 ja iteraatioiden määrään 20.
Parhautta oltiin tutkittu RMSE metriikan kautta ja kyseisillä paramtreilla RMSE saatiin pienimmillään eli mallin voidaan sanoa sovittuvan parhaiten opetusdataan.
Tutkimuksessa oltiin päädytty arvoon XXX, kun taas paras itse opetettu malli päätyi RMSE arvoon 0.8071669083077276, jolloin ne ovat hyvin lähellä toisiaan.
