...
Pystytin AWS EMR liukuhihnan (pipeline) ohjeiden VIITE mukaisesti.
...
Onneksi asian sai selvitettyä asiakaspalvelun kanssa ja AWS insinöörit tarkistivat pyynnöstäni lokeista että olin tosiasiassa käyttänyt EMR liukuhihnaani vain muutaman kerran kuten kerroinkin.
AWS supportille kiitosta siitä kuinka mutkattomasti asia hoitui lopulta: pyyhkivät kuukauden laskun kokonaan ja lisäsivät kuluvalle kuulle krediittejä sen verran että lasku tulisi kuitattua.
