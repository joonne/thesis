...
Recommender Systems are a set of techniques and software tools that provide suggestions to users about potentially useful items. \cite{ricci11} Item denotes the general subject that the system recommends to users.
