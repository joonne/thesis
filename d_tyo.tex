...
Example actions include count, show, or writing data out to file systems.

Datasets are "lazy", which refers to that computations are only triggered when an action is invoked.
