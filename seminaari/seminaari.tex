...
%------------------------------------------------
\section{Tavoitteet} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------
...
Akateeminen osuus hoidettiin etsimällä tutkimuspaperi, johon perustin oman mallin opetukseni.
