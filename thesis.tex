...
Tämän työn tekemiseen kului noin 900 päivää, tyäpaikan vaihto, epätoivoa, laiskuutta ja lopuksi vielä kaaos AWS:n laskun kanssa, mutta onneksi myäs muutamia oivalluksen hetkiä.

Erityiskiitos tuesta vaimolleni Nooralle.
Kiitos myäs kaikille muille ketkä jaksoivat muistuttaa, hoputtaa ja välillä hymähdelläkin tämän työn tekemiselle ja tekemisestä, ilman tuota hoputusta olisin varmaankin täyttämässä jo toista jatkoaikahakemustani!
