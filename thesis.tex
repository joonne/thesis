...
This paper studies the usage of Apache Spark when building a recommendation engine with Scala programming language and Amazon Web Services (AWS).
...
Tämän työn tekemiseen kului noin 900 päivää, työpaikan vaihto, epätoivoa, laiskuutta, kaaos AWS:n laskun kanssa, mutta onneksi myös muutamia oivalluksen hetkiä.

Kiitos kaikille ketkä jaksoivat muistuttaa, hoputtaa ja välillä hymähdelläkin tämän työn tekemiselle ja tekemisestä, ilman tuota hoputusta olisin varmaankin täyttämässä toista jatkoaikahakemustani.
