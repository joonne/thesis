...
Tämän työn tekemiseen kului noin 900 päivää, työpaikan vaihto, hikeä, saamattomuutta, laiskuutta, kaaos Amazonin laskun kanssa, mutta onneksi myös muutamia oivalluksen hetkiä.

Kiitos kaikille ketkä jaksoivat muistuttaa, hoputtaa ja välillä hymähdelläkin tämän työn tekemisestä, ilman tuota hoputusta olisin varmaankin täyttämässä jo toista jatkoaikahakemusta.
